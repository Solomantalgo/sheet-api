...
export declare namespace cloudbilling_v1beta {
    ...
    export class Resource$Billingaccounts$Skus$Prices {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Billingaccounts$Skus$Prices$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Billingaccounts$Skus$Prices$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudBillingBillingaccountpricesV1betaListBillingAccountPricesResponse>;
    ...
    export class Resource$Skus$Prices {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Skus$Prices$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Skus$Prices$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudBillingPricesV1betaListPricesResponse>;
