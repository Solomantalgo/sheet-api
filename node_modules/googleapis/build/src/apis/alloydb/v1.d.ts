...
export declare namespace alloydb_v1 {
    ...
    export class Resource$Projects$Locations$Clusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateClientCertificate(params: Params$Resource$Projects$Locations$Clusters$Generateclientcertificate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generateClientCertificate(params?: Params$Resource$Projects$Locations$Clusters$Generateclientcertificate, options?: MethodOptions): GaxiosPromise<Schema$GenerateClientCertificateResponse>;
        generateClientCertificate(params: Params$Resource$Projects$Locations$Clusters$Generateclientcertificate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generateClientCertificate(params: Params$Resource$Projects$Locations$Clusters$Generateclientcertificate, options: MethodOptions | BodyResponseCallback<Schema$GenerateClientCertificateResponse>, callback: BodyResponseCallback<Schema$GenerateClientCertificateResponse>): void;
        generateClientCertificate(params: Params$Resource$Projects$Locations$Clusters$Generateclientcertificate, callback: BodyResponseCallback<Schema$GenerateClientCertificateResponse>): void;
        generateClientCertificate(callback: BodyResponseCallback<Schema$GenerateClientCertificateResponse>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Clusters$Generateclientcertificate extends StandardParameters {
        /**
