...
export declare namespace contactcenterinsights_v1 {
    ...
    export class Resource$Projects$Locations$Conversations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        bulkDelete(params: Params$Resource$Projects$Locations$Conversations$Bulkdelete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        bulkDelete(params?: Params$Resource$Projects$Locations$Conversations$Bulkdelete, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
