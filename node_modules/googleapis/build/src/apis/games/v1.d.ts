...
export declare namespace games_v1 {
    ...
    export class Resource$Recall {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        linkPersona(params: Params$Resource$Recall$Linkpersona, options: StreamMethodOptions): GaxiosPromise<Readable>;
        linkPersona(params?: Params$Resource$Recall$Linkpersona, options?: MethodOptions): GaxiosPromise<Schema$LinkPersonaResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resetPersona(params: Params$Resource$Recall$Resetpersona, options: StreamMethodOptions): GaxiosPromise<Readable>;
        resetPersona(params?: Params$Resource$Recall$Resetpersona, options?: MethodOptions): GaxiosPromise<Schema$ResetPersonaResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveTokens(params: Params$Resource$Recall$Retrievetokens, options: StreamMethodOptions): GaxiosPromise<Readable>;
        retrieveTokens(params?: Params$Resource$Recall$Retrievetokens, options?: MethodOptions): GaxiosPromise<Schema$RetrievePlayerTokensResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        unlinkPersona(params: Params$Resource$Recall$Unlinkpersona, options: StreamMethodOptions): GaxiosPromise<Readable>;
        unlinkPersona(params?: Params$Resource$Recall$Unlinkpersona, options?: MethodOptions): GaxiosPromise<Schema$UnlinkPersonaResponse>;
