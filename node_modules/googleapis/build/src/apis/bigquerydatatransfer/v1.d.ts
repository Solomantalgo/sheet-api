...
export declare namespace bigquerydatatransfer_v1 {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        unenrollDataSources(params: Params$Resource$Projects$Locations$Unenrolldatasources, options: StreamMethodOptions): GaxiosPromise<Readable>;
        unenrollDataSources(params?: Params$Resource$Projects$Locations$Unenrolldatasources, options?: MethodOptions): GaxiosPromise<Schema$Empty>;
