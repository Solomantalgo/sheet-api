...
export declare namespace walletobjects_v1 {
    ...
    export class Resource$Walletobjects$V1$Privatecontent {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        uploadPrivateData(params: Params$Resource$Walletobjects$V1$Privatecontent$Uploadprivatedata, options: StreamMethodOptions): GaxiosPromise<Readable>;
        uploadPrivateData(params?: Params$Resource$Walletobjects$V1$Privatecontent$Uploadprivatedata, options?: MethodOptions): GaxiosPromise<Schema$UploadPrivateDataResponse>;
        uploadPrivateData(params: Params$Resource$Walletobjects$V1$Privatecontent$Uploadprivatedata, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        uploadPrivateData(params: Params$Resource$Walletobjects$V1$Privatecontent$Uploadprivatedata, options: MethodOptions | BodyResponseCallback<Schema$UploadPrivateDataResponse>, callback: BodyResponseCallback<Schema$UploadPrivateDataResponse>): void;
        uploadPrivateData(params: Params$Resource$Walletobjects$V1$Privatecontent$Uploadprivatedata, callback: BodyResponseCallback<Schema$UploadPrivateDataResponse>): void;
        uploadPrivateData(callback: BodyResponseCallback<Schema$UploadPrivateDataResponse>): void;
    }
    export interface Params$Resource$Walletobjects$V1$Privatecontent$Uploadprivatedata extends StandardParameters {
        /**
         * Request body metadata
         */
