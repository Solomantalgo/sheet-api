...
export declare namespace analyticsdata_v1beta {
    ...
    export class Resource$Properties$Audienceexports {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Properties$Audienceexports$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Properties$Audienceexports$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Properties$Audienceexports$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Properties$Audienceexports$Get, options?: MethodOptions): GaxiosPromise<Schema$AudienceExport>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Properties$Audienceexports$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Properties$Audienceexports$List, options?: MethodOptions): GaxiosPromise<Schema$ListAudienceExportsResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        query(params: Params$Resource$Properties$Audienceexports$Query, options: StreamMethodOptions): GaxiosPromise<Readable>;
        query(params?: Params$Resource$Properties$Audienceexports$Query, options?: MethodOptions): GaxiosPromise<Schema$QueryAudienceExportResponse>;
