...
export declare namespace analyticsadmin_v1alpha {
    ...
    export class Resource$Properties {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        createSubproperty(params: Params$Resource$Properties$Createsubproperty, options: StreamMethodOptions): GaxiosPromise<Readable>;
        createSubproperty(params?: Params$Resource$Properties$Createsubproperty, options?: MethodOptions): GaxiosPromise<Schema$GoogleAnalyticsAdminV1alphaCreateSubpropertyResponse>;
        createSubproperty(params: Params$Resource$Properties$Createsubproperty, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        createSubproperty(params: Params$Resource$Properties$Createsubproperty, options: MethodOptions | BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaCreateSubpropertyResponse>, callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaCreateSubpropertyResponse>): void;
        createSubproperty(params: Params$Resource$Properties$Createsubproperty, callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaCreateSubpropertyResponse>): void;
        createSubproperty(callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaCreateSubpropertyResponse>): void;
        /**
    ...
    export interface Params$Resource$Properties$Createsubproperty extends StandardParameters {
        /**
         * Request body metadata
         */
